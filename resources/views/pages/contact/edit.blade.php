            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h6 class="text-center">Edit kontak</h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('contacts.update', $item->id) }}" method="post" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" id="icon" value="{{ $item->icon ?? old('icon') }}">
                                @error('icon')
                                    <div class="is-invalid">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="number" class="form-control @error('number') is-invalid @enderror" id="number" value="{{ $item->number ?? old('number') }}">
                                @error('number')
                                    <div class="is-invalid">
                                        {{ $message }}
                                    </div>
